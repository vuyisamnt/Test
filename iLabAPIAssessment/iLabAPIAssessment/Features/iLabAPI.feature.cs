...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Add new pet with auto generated name and status available and retrieve pet using " +
            "the category id")]
        [NUnit.Framework.TestCaseAttribute("VuyisaTest", "50", "available", null)]
        public virtual void AddNewPetWithAutoGeneratedNameAndStatusAvailableAndRetrievePetUsingTheCategoryId(string name, string categoryId, string status, string[] exampleTags)
        {
...
#line hidden
#line 18
 testRunner.When(string.Format("I set up the body and submit POST request with name \'{0}\', category Id \'{1}\' and " +
                            "status \'{2}\'", name, categoryId, status), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 19
 testRunner.And(string.Format("I confirm the json has the name \'{0}\' with category id \'{1}\'", name, categoryId), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 20
...
#line hidden
#line 22
 testRunner.Then(string.Format("I should see pet is returned from request \'{0}\'", name), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
